...
"""Набор моделей, доступных для использования в качестве транскрибатора."""
...
class TranscriptionWord:
    ...
    start: float
    """Время начала слова в секундах от начала аудиозаписи."""

    end: float
    """Время окончания слова в секундах от начала аудиозаписи."""

    text: str
    """Транскрибированный текст слова."""

    speaker: str | None = None
    """Опциональный идентификатор говорящего, произнёсшего это слово."""

    probs: float | None = None
    """Опциональная оценка вероятности правильности распознавания слова."""
...
class TranscriptionSegment:
    ...
    start: float
    """Время начала сегмента в секундах от начала аудиозаписи."""

    end: float
    """Время окончания сегмента в секундах от начала аудиозаписи."""

    text: str
    """Полный транскрибированный текст сегмента."""

    words: list[TranscriptionWord] = field(default_factory=list)
    """Список объектов слов с детальной информацией о времени и метаданных."""
